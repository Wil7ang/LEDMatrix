...
unsigned char* encodeLetters(const char* str, /*int* colors*/ int color, int length, int offset, int currentRow, int &lastFirstLetter, int &curWidthSum, td::map<char, std::pair<int, int> > &characterDictionary)
{
